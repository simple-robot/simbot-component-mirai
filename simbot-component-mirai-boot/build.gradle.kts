...
dependencies {
    ...
    compileOnly("love.forte.simbot.boot:simboot-api:$SIMBOT_VERSION")
    ...
    testImplementation("love.forte.simbot.boot:simboot-core-spring-boot-starter:$SIMBOT_VERSION")
